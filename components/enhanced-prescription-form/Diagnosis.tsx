      ...
      <div className="w-full sm:w-3/4 p-3 sm:p-4">
        <div className="space-y-4">
          ...
          <Accordion type="multiple" className="w-full space-y-3">
            <AccordionItem
              value="diagnosis"
              className="border border-red-100 dark:border-red-600 rounded-lg px-3 sm:px-4 bg-gradient-to-b from-red-50 to-white dark:from-gray-800 dark:to-gray-900"
            >
              <AccordionTrigger className="py-3 hover:no-underline group">
                <div className="flex items-center gap-2 w-full">
                  <div className="p-1.5 bg-red-100 dark:bg-red-900 rounded-lg group-hover:bg-red-200 dark:group-hover:bg-red-800 transition-colors">
                    <Stethoscope className="h-4 w-4 sm:h-5 sm:w-5 text-red-500 dark:text-red-300" />
                  </div>
